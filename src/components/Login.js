                ...
                <div className="row justify-content-center">
                  <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form className="mx-1 mx-md-4" onSubmit={handleLogin}>
                      ...
                      <button type="submit" className="btn btn-primary btn-md" onClick={handleLogin}>
                        {/* Loader */}
                        {loading ? (
                      ...
                      <p className="small fw-bold mt-2 pt-1 mb-0">Vous n'avez pas de compte ? <Link to="/" className="link-danger">Inscrivez-vous</Link></p>
                    </form>
                  </div>
